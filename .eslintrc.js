module.exports = {
  ...
  extends: ['airbnb-typescript', 'next/core-web-vitals', 'plugin:storybook/recommended'],
  ...
  rules: {
    ...
    'import/no-extraneous-dependencies': ['error', {
      devDependencies: ['**/*.spec.js', '**/*.spec.jsx', '**/*.spec.ts', '**/*.spec.tsx', 'src/tests/**/*', 'cypress/**/*', '**/*.stories.tsx']
    }],
    'import/order': ['warn', {
